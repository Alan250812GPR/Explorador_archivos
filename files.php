...
//Application Title
define('APP_TITLE', 'Gestor de Archivos Importaciones');
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label for="fm_pwd"><?php echo lng('Contraseña'); ?></label>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block">Gestor de Archivos <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12">Gestor de Archivos <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
function lng($txt) {
    ...
    $tr['en']['Login']          = 'Iniciar Sesion';                $tr['en']['Username']           = 'Username';
